...
config.output.filename = 'open-sims-delegated-admin.ui.' + project.version + '.js';
...
config.plugins = config.plugins.concat([
  ...
  new ExtractTextPlugin('open-sims-delegated-admin.ui.' + project.version + '.css', {
    allChunks: true
  }),

  // Separate the vender in a different file.
  new webpack.optimize.CommonsChunkPlugin('vendors', 'open-sims-delegated-admin.ui.vendors.' + project.version + '.js'),
